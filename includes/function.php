...
function processOrder($srow,$notify=true){
	...
	if($srow['type']=='alipay' && isset($conf['money_rate_alipay']) && $conf['money_rate_alipay']>0){
		$rate = $conf['money_rate_alipay'];
	}elseif($srow['type']=='wxpay' && isset($conf['money_rate_wxpay']) && $conf['money_rate_wxpay']>0){
		$rate = $conf['money_rate_wxpay'];
	}elseif($srow['type']=='qqpay' && isset($conf['money_rate_qqpay']) && $conf['money_rate_qqpay']>0){
		$rate = $conf['money_rate_qqpay'];
	}

...
$sql="update `pay_user` set `account` ='{$account}',`username` ='{$username}',`money` ='{$money}',`url` ='{$url}',`type` ='$type',`settle_id` ='$settle_id',`email` ='$email',`qq` ='$qq',`phone` ='$phone',`rate` ='$rate',`active` ='$active' where `id`='$id'";
if($_POST['resetkey']==1){
	$key = random(32);

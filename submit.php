...
if($type=='alipay'){
	if(strpos($_SERVER['HTTP_USER_AGENT'], 'MicroMessenger')!==false){
		echo "<script>window.location.href='./submit2.php?type=alipay&trade_no={$trade_no}';</script>";exit;
	}
	...
	if(checkmobile()==true){
		echo "<script>window.location.href='./qqwappay.php?trade_no={$trade_no}&type=qqpay&sitename={$sitename}';</script>";
	}else{
		echo "<script>window.location.href='./qqpay.php?trade_no={$trade_no}&type=qqpay&sitename={$sitename}';</script>";
	}
}else{
